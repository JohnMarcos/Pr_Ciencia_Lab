class LessonsController < ApplicationController
  ...
  def create
    ...
    if enrollment.nil?
      ...
      if @lesson.save
        redirect_to course_enrollment_lesson_mis_lecciones_creadas_path(course_id: params[:course_id], enrollment_id: params[:enrollment_id], lesson_id: @lesson.id)
      else
        render :new
      end
    end
  ...
  def update
    ...
    redirect_to course_enrollment_lesson_mis_lecciones_creadas_path(course_id: params[:course_id], enrollment_id: enrollment.id, lesson_id: params[:lesson_id])
  end
